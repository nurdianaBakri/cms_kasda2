    ...
    $.ajax({
        ...
        {  
           $('.form_container').html(response);
            ...
            $('.modal-title').text('Tambah Pemeliharaan Rekening sumber'); // Set Title to Bootstrap modal title
        },
    ...
    $.ajax({
        ...
        {   
           $('.form_container').html(data);  
            ...
            $('.modal-title').text('Ubah Pemeliharaan Rekening sumber');
    ...
    if(confirm('Apakah anda yakin menghapus data ?'))
    {
        ...
        $.ajax({
            ...
            { 
                ...
                $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
                $('.modal-title').text('Hapus Rekening sumber'); // Set title to Bootstrap modal title
