...
class Sp2d_sudah_cair extends CI_Controller {

    private $root_url = "Laporan/LapTrsans/Sp2d_sudah_cair"; 
	...
	{ 
		$data['title'] = "Daftar SP2D Sudah Cair";
        $data['url'] = "laporan/LapTrsans/Sp2d_sudah_cair/";  

     
        // var_dump($data); 
		$this->load->view('include/header'); 
        $this->load->view('laporan/transaksi/SP2D_sudah_cair/index',$data);
     ...
     public function get_form()
    {
        ...
        $this->load->view('laporan/transaksi/SP2D_sudah_cair/form',$data); 
    }
    ...
    {    
        ...
        $this->load->view('laporan/transaksi/SP2D_sudah_cair/data',$data); 
    }
    ...
    { 
        ...
        $cek = $this->M_laporan_SP2D_sudah_cair->get_laporan($tglawal, $tglakhir, $KD_KASDA, $jenis_spm);
        if ($cek->num_rows()>0)
        {
    ...
    {  
        ...
        $excel->getProperties()->setCreator('My Notes Code')
                        ...
                        ->setTitle("Data SP2D Yang Sudah Cair")
                        ->setSubject("Siswa")
        ...
        header('Content-Disposition: attachment; filename="DaftarSP2DBelumCair.xlsx"');
