...
class DaftarUserKasda extends CI_Controller {
    ...
    { 
        ...
        $data['url'] = "Laporan/lapSec/DaftarUserKasda/";    
        
        $this->load->view('include/header'); 
        $this->load->view('laporan/security/daftar_user_kasda/index',$data);
    ...
    {     
        ...
        $this->load->view('laporan/security/daftar_user_kasda/data',$data);  
    }  

    public function get_form()
    {    
        $data['kasda']= $this->M_laporan_rekKoran->get_kasda();   
        $this->load->view('laporan/security/daftar_user_kasda/get_form',$data);  
    } 
