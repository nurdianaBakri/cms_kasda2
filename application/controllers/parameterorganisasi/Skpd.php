...
class Skpd extends CI_Controller {
    ...
    public function cek_file()
    {
        ...
        if($upload['result'] == "success"){ // Jika proses upload sukses
            ...
            $ext = $upload['file']['file_ext']; 
 
            if ($ext=='.xlxs')
            {
                $excelreader = new PHPExcel_Reader_Excel2007();
                $loadexcel = $excelreader->load('excel/'.$this->filename.$ext); // Load file yang tadi diupload ke folder excel
            ...
            if($numrow > 1){  
                ...
                { 
                    ...
                    array_push($data_urusan, array(
                        ...
                        'USER_INPUT'=>$this->session->userdata('KD_KASDA'), // Insert data alamat dari kolom D di excel
                    ));
                }
