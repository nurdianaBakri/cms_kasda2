                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                          <form action="/action_page.php">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-10">
                                                <input name="group5" type="radio" id="radio_a" class="with-gap radio-col-green" />
                                                <label for="radio_a">Aktif</label>
                                              </div>
                                              <div class="col-10">
                                                <input name="group5" type="radio" id="radio_ta" class="with-gap radio-col-green" />
                                                <label for="radio_ta">Tidak</label>
                                              </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-15">
                                                ...
                                                <div class="col-75">
                                                    <textarea type="text" id="uraian" name="uraian" rows="15" ></textarea>
                                                </div>
                                            </div>
                                        </form>
                                        </div>
