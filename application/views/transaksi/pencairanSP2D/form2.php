...
<div class="panel panel-success">
  ...
  <div class="panel-body">
    ...
    <input type="hidden" id="STATUS_SP2D" name="STATUS_SP2D" value="3" > 
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <input type="text" id="NO_REK" class="form-control input-visible" name="NO_REK"   value="<?php echo $NO_REK ?>" required readonly>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <input type="text" id="NILAI_SP2D" class="form-control input-visible" name="NILAI_SP2D" value="<?php echo $NILAI_SP2D ?>" required  readonly>
      </div>
      <div class="col-md-2">
        <label for="NILAI_POTONGAN">Potongan</label>
      </div>
      <div class="col-md-4">
        <input type="text" id="NILAI_POTONGAN" class="form-control input-visible" name="NILAI_POTONGAN" value="<?php echo $NILAI_POTONGAN ?>" required readonly>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <input type="text" id="NILAI_TRANSFER" class="form-control input-visible" name="NILAI_TRANSFER" value="<?php echo $NILAI_TRANSFER ?>" required readonly>
      </div>
    </div>
  </div>
</div>
                    ...
                    $.ajax( {
                        ...
                        success: function( response ) { 
                          ...
                          {   
                            ...
                            $('#Rek_Penerima').val(response.Rek_Penerima);  
