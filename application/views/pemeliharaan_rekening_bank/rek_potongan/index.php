                    ...
                    <div class="header">
                        <div class="row clearfix">
                            <div class="col-xs-12 col-sm-6">
                                <h2>PEMELIHARAAN REK POTONGAN</h2>
                            </div> 
                            <button class="btn pull-right btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Tambah Rek. Potongan</button>
                        </div>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
...
<script src="<?php echo base_url()."assets/" ?>fungsi/fgs_pemeluharaaanRekPotongan.js"></script> 
