                                    ...
                                    <div class="panel-body">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                          <form action="/action_page.php">
                                            ...
                                            <div class="row">
                                                <div class="col-10">
                                                    <label for="kd_cabang">Kode Cabang</label>
                                                </div>
                                                <div class="col-50">
                                                   <select class="form-control" name="kd_cabang">
                                                       <option></option>
                                                       <option>000 - KANTOR PUSAT</option>
                                                       <option>001 - CABANG UTAMA PEJANGGIK</option>
                                                       <option>002 - CABANG SELONG</option>
                                                       <option>003 - CABANG PRAYA</option>
                                                       <option>004 - CABANG SUMBAWA</option> 
                                                   </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-10">
                                                    <label for="kd_sd">Kd Sumber Dana</label>
                                                </div>
                                                <div class="col-50">
                                                   <select class="form-control" name="kd_sd">
                                                       <option></option>
                                                   </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-50">
                                                    <input type="text" id="nm_pemilik" name="nm_pemilik" disabled>
                                                </div>
                                            </div>
                                        </form>
                                        </div>
                                        ...
                                        <div class="body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                                    <thead>
                                                        <tr>
                                                            <th width="10%">Kd Kasda</th>
                                                            <th width="10%">Kd Cabang</th>
                                                            <th width="15%">Kd Sumber Dana</th>
