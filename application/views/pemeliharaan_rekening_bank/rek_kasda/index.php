                        ...
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                  ...
                                  <button class="btn pull-right btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Tambah Rek. Kasda</button>
                            </div>
                        </div>
                        <div class="body"> 
    ...
    <script src="<?php echo base_url()."assets/" ?>fungsi/fgs_pemeliharaaanRekSumber.js"></script> 
