<section class="content">
                                                    ...
                                                    if ($this->session->userdata('LEVEL_USER')=="SU") {
                                                       ?> 
                                                        ...
                                                        { ?> 
                                                            ...
                                                            <input readonly type="text" class="form-control" value="<?= $this->session->userdata('KD_KASDA')." - ". $this->session->userdata('NM_KASDA'); ?>"  id="kd_kasda">
                                                    <?php }  ?>
                                                </div>
                                            </div>  
                                    </form>   
    ...
    $( document ).ready(function() {  
        ...
        reload_data(kd_kasda);
    });

    function reload_data(kd_kasda) { 
        $('#loading').show(); 
