                    ...
                    <div class="card">
                        <div class="header">
                            <div class="row clearfix">
                                ...
                                <button class="btn pull-right btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> MAP</button>
                            </div>
                        </div>
                        <div class="body">
    ...
    <script src="<?php echo base_url()."assets/" ?>fungsi/fgs_mapingMap.js"></script> 
