...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?= base_url()?>assets/assets_login/images/bg-01.jpg');">  
				...
				<form class="login100-form validate-form" action="<?php echo base_url('login/aksi_login'); ?>" method="post">	
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						...
						<input class="input100" type="text"   title="Masukkan 5 character"  maxlength="5" name="username" placeholder="Type your username">
